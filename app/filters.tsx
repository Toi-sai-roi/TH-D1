        ...
        {CATEGORIES.map(cat => (
          ...
          >
            <View style={[s.checkbox, selCats.includes(cat) && s.checked]}>
              {selCats.includes(cat) && <Ionicons name="checkmark" size={14} color="#fff" />}
            </View>
        ...
        {BRANDS.map(brand => (
          ...
          >
            <View style={[s.checkbox, selBrands.includes(brand) && s.checked]}>
              {selBrands.includes(brand) && <Ionicons name="checkmark" size={14} color="#fff" />}
            </View>
...
const s = StyleSheet.create({
  ...
  checkbox: { width: 22, height: 22, borderRadius: 6, borderWidth: 1.5, borderColor: '#ddd', justifyContent: 'center', alignItems: 'center' },
  checked: { backgroundColor: '#4CAF6F', borderColor: '#4CAF6F' },
  rowLabel: { fontSize: 15, color: '#1a1a1a' },
  applyBtn: { backgroundColor: '#4CAF6F', borderRadius: 16, paddingVertical: 16, alignItems: 'center', marginBottom: 32 },
