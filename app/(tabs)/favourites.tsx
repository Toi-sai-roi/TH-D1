  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.footer}>
        <TouchableOpacity
          style={s.addAllBtn}
          onPress={() => { favs.forEach(item => addItem({ ...item, img: null })); router.push('/(tabs)/cart'); }}
        >
...
const s = StyleSheet.create({
  ...
  addAllBtn: { backgroundColor: '#4CAF6F', borderRadius: 16, paddingVertical: 16, alignItems: 'center' },
