export type Product = {
  ...
  export const ALL_PRODUCTS: Product[] = [
    { id: '1', name: 'Natural Red Apple', weight: '1kg', price: 4.99, icon: '🍎', detail: 'Apples are nutritious. Apples may be good for weight loss. Apples are good for your heart.', nutrition: { calories: '52kcal', fat: '0.2g', sugar: '10g', protein: '0.3g' } },
    { id: '2', name: 'Organic Bananas', weight: '7pcs', price: 4.99, icon: '🍌', detail: 'Bananas are among the world\'s most popular fruit.', nutrition: { calories: '89kcal', fat: '0.3g', sugar: '12g', protein: '1.1g' } },
    { id: '3', name: 'Beef Bone', weight: '1kg', price: 4.99, icon: '🥩', detail: 'Fresh beef bone, great for soups and broths.', nutrition: { calories: '120kcal', fat: '8g', sugar: '0g', protein: '11g' } },
    { id: '4', name: 'Broiler Chicken', weight: '1kg', price: 4.99, icon: '🍗', detail: 'Fresh broiler chicken, high in protein and low in fat.', nutrition: { calories: '165kcal', fat: '3.6g', sugar: '0g', protein: '31g' } },
    ...
    { id: 'f3', name: 'Organic Bananas', weight: '5kg', price: 3.00, icon: '🍌', detail: 'Organic bananas.', nutrition: { calories: '89kcal', fat: '0.3g', sugar: '12g', protein: '1.1g' } },
    ...
    { id: 'm1', name: 'Beef Bone', weight: '1kg', price: 4.99, icon: '🥩', detail: 'Fresh beef bone for soups.', nutrition: { calories: '120kcal', fat: '8g', sugar: '0g', protein: '11g' } },
    { id: 'm2', name: 'Broiler Chicken', weight: '1kg', price: 4.99, icon: '🍗', detail: 'Fresh broiler chicken.', nutrition: { calories: '165kcal', fat: '3.6g', sugar: '0g', protein: '31g' } },
    ...
    { id: 'd3', name: 'Eggs', weight: '12pcs', price: 2.99, icon: '🥚', detail: 'Fresh farm eggs.', nutrition: { calories: '78kcal', fat: '5g', sugar: '0g', protein: '6g' } },
